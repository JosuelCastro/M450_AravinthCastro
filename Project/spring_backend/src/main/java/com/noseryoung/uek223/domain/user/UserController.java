...
import com.noseryoung.uek223.domain.user.dto.UserDTO;
import com.noseryoung.uek223.domain.user.dto.UserMapper;
import com.noseryoung.uek223.domain.user.dto.UserRegisterDTO;
...
public class UserController {
    ...
    @GetMapping
    @PreAuthorize("hasAuthority('ADMIN_READ')")
    public ResponseEntity<List<UserDTO>> retrieveAll(@RequestParam(value = "page") @NumberFormat Integer page,
                                                     @RequestParam(value = "amount") @NumberFormat Integer amount) {
        List<User> users = userService.findAll(PageRequest.of(page, amount));
